...
function ConsolesPage() {
...

    {
      ...
      consoles: [
...

        {
          ...
          image:
            '/foto de consoles/nintendo 64.png',
...

        {
          ...
          image:
            '/foto de consoles/nintendo wii.png',
...

        {
          ...
          image:
            '/foto de consoles/gameboycolor.png',
      ...
      consoles: [
        {
          ...
          image:
            '/foto de consoles/Xbox classico.png',
...

        {
          ...
          image:
            '/foto de consoles/xboxseriesx.png',
  ...
  const getConsoleImage =
    (catalogConsole) => {
      return (
        catalogConsole?.image ||
        null
      );
    };


  const findOwnedConsole =
    (catalogConsole) => {
      const aliases =
        (
          catalogConsole
        ...
        <main className="consoles-main">
          ...
          {!selectedConsole && (
            <section className="consoles-hero">
              ...
              <p>
                Uma vitrine através das
                gerações de PlayStation,
                Nintendo e Xbox. Os
                consoles destacados fazem
                ...
                {selectedConsole && (
                  <section className="selected-console-section">
                    ...
                    <div className="selected-console-header">
                      ...
                      {getConsoleImage(
                        ...
                        <div className="selected-console-image">
                          ...
                          <div className="selected-console-glow">
                          </div>
                    ...
                    <div className="games-title">
                      ...
                      <div className="games-title-line">
                      </div>
                        ...
                        <div className="game-carousel-stage">
                          ...
                          <div className="game-carousel-content">
                            ...
                            <div className="game-carousel-cover-side">
                              ...
                              <div className="game-carousel-cover-glow">
                              </div>
