...
function BeybladePage() {
  ...
  const fetchBeybladeData = async () => {
    ...
    try {
      ...
      console.error(
        'Erro ao carregar dados de Beyblade:',
        error
      );

      setMessage(
        'Não foi possível carregar os dados de Beyblade.'
      );
    } finally {
      setLoading(false);
    }
